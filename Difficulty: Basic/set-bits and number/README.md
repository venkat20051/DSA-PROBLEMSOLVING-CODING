<h2><a href="https://www.geeksforgeeks.org/problems/got-tv-series3124/1?page=1&category=Bit%20Magic&difficulty=Basic&sortBy=latest">set-bits and number</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>. Find the product of the number of setbits and the&nbsp;number itself.</span></p>
